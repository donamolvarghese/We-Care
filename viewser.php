...
?>
        	...
        	<div class="img">
			       <span> <img src="<?php echo $row['image']; ?>" width="40" height="40" alt="" class="img-border img-indent"></span>

    				<!--<img src="<?php //echo $row['image']?>"  alt=""><br><br>-->
					
  				<div class="desc">
    				<?php 
					$p=$row['type'];
					echo $row['type']?><br>
					<?php echo $row['charge']?><br>
					<?php 
                   $sql1="SELECT `id` as cid FROM `category` where `NAME`='$p'";
                   $result1=mysqli_query($db,$sql1);
				   $row1=mysqli_fetch_array($result1);
				   $cid=$row1['cid'];
				   ?>
					<center> <a href="emp1.php?id=<?php echo $row['id'];?>&cid=<?php echo $cid; ?>">view more</a> </center>
 				 </div>
				 </li>
			</div>
			<!--</div>-->
