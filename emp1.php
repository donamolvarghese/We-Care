    ...
    <body>
        ...
        <header class="header clearfix">
        	<div class="wrapper clearfix">
				...
				<?php 
				   $sql1="SELECT `NAME` as name FROM `category` where `id`='$id1'";
                   $result1=mysqli_query($db,$sql1);
				   $row1=mysqli_fetch_array($result1);
				   $name=$row1['name'];
                   $sql2="SELECT `RID`,`NAME`, `PLACE`, `PHONE`, `EMAIL`, `GENDER`, `DOB`, `PHOTO`, `CATGORY`, `RESUME` FROM `employee registration` WHERE CATGORY='$name'";
...
?>
  				...
  				<div class="desc">
					...
					<?php //$_session['emppid']=$row['RID'];?>
				
					<div >
                      <center> <a href="boo.php?id=<?php echo $id;?>&eid=<?php echo $row['RID'];?>&pid=<?php echo $row['PHONE'];?>&aid=<?php echo $row['PLACE'];?>&bid=<?php echo $row['NAME'];?>">BOOK</a> </center>
