        	...
        	<div class="img">
  				...
  				<div class="desc">
					...
					<?php echo $row['ADHAAR']?><br>
					 ...
					 <select name="rate" class="form-control" style="margin-left:10%; border-radius:5px;">
              ...
              <input type="hidden" name="catid" value="<?php echo $row['category id']?>">
     <input type='submit' value='Submit Rate' name="sub" style="border-radius:5px; margin-left:10%;">
 				 </div>
				 <?php
//$cat_id=$row['RID'];
//echo $cat_id;
//$sql1="SELECT count(*) as count,sum(rat) as tot_rate FROM `rat` where RID=$cat_id"; //value querried from the table
//echo $sql1;
...
//$sql1="SELECT count(*) as count,sum(rat) as tot_rate FROM `rat` where itemid=$cat_id"; //value querried from the table
