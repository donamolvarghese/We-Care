...
?>
        	...
        	<div class="img">
    				<img src="<?php echo $row['image']?>" alt="Trolltunga Norway"><br><br>
  				<div class="desc">
    				<?php echo $row['city']?><br>
					<b>by:  </b><?php echo $row['address']?>
   				 
					<input type="hidden" value="<?php echo $row['district']?>" name="pid" /><br>
					
                   <center> <a href="testingbook.php?id=<?php echo $row['hid']; ?>"> VIEW MORE DETAILS</a> </center>
 				 </div>
				 </li>
			</div>
			<!--</div>-->
