...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO `book`( `NAME`, `PLACE`, `ADDRESS`, `PHONE`, `EMAIL`, `date`, `EMPLOYEE`, `CATEGORY`) VALUES ('$a','$b','$c','$d','$e','$h','$f','$g')";
    ...
    <body>
        ...
        <div class="wrapper clearfix">
            ...
            <div id="about" class="clearfix">
                ...
                <div class="enquire_right">
               <input name="place" type="text" class="text_box" id="place" placeholder="Place...">
				
                </div>
               
                  <div class="enquire_right">
                    	<input name="address" type="text" class="enquiry_box" id="address" placeholder="Address...">
                    </div>
                    <div class="enquire_right">
					...
					<div class="enquire_right">
                    	<input name="date" type="date" class="text_box" id="date" placeholder="Date...">
                    </div>
                    ...
                    <select  class="form-control" name="emp" id="Specialization_in" data-rule="required"  title="you should choose your area of specialization" required>

																		<?php
																			$sql="SELECT `RID`, `NAME`FROM `employee registration` WHERE  Status=1";
                     ...
                     <label for="category">
                                   Select  Category</label>
                                																	<select  class="form-control" name="cat" id="Specialization_in" data-rule="required"  title="you should choose your area of specialization" required>
					...
					<div>
					<div> <a name="submit" style="green" href="Emp.php"</a>VIEW PROFILE EMPLOYEE</div></div>
