...
<META name="organization" content="OurCare cleaning service" />
    ...
    <body>
        ...
        <div class="wrapper clearfix">
			...
			<?php 
          $sql="SELECT username FROM register WHERE  username='$id'";
...
{
	echo $row['username'];?> &nbsp&nbsp<?php
   ...
   while($row=mysqli_fetch_array($result))
   {
     ?>
            <center>
            <div id="welcome">
            	<table width="1321" height="455"><tr>
    <td width="10" height="449">&nbsp;</td>
    <td width="515"> <div class="signup1">
  
    <table height="242">
   <form name="login" id="login" action="#" method="post">
      <tr>
       <td  align="center"><h2><span>MY</span> PROFILE</h2></td>
