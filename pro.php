        ...
        <div class="boxed-grey">
            ...
            <div class="col-md-3">
              ...
              <div class="form-group">
                  <label for="photo">
                      Upload photo</label>
                  <img src="<?php echo $rows['PHOTO'] ?>" alt="test"   name="photo"    id="photo" height="150" width="150"/>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="gender">
                            Place</label></br>
                        <input type="text" name="gender" class="form-control" id="gender" value="<?php echo $row['PLACE']?>" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
