...
<META name="organization" content="OurCare cleaning service" />
	...
	WELCOME &nbsp&nbsp&nbsp&nbsp<?php 
$sql="select name from register where Reg_id='$id'";
...
?> 
                ...
                <div class="head clearfix">
                    ...
                    <div class="menu">
                    	<nav>
                          ...
                          <a href="rat.php">Feedback</a>
                        	<a href="empvi.php">View Employee</a>
							<a href="prof.php">profile</a>
							<a href="viewser.php">View Service</a>
        ...
        <section class="features clearfix">
            <div id="features_main" class="clearfix">
            	<div id="features">
                         <a href="services.php"><img src="images/residential.jpg" alt="residential Cleaning service image"></a>
              </div>
            	<div id="features">
                         <a href="services.php"><img src="images/commercial1.jpg" alt="commercial cleaning service image"></a>
              </div>
            	<div id="features">
                         <a href="services.php"><img src="images/carpet.jpg" alt="carpet cleaning cleaning image"></a>
              </div>
            	<div id="features">
                         <a href="services.php"><img src="images/afterconstruction.jpg" alt="after construction cleaning service image"></a>
              </div>
            	<div id="features">
                         <a href="services.php"><img src="images/movein_cleaning.jpg" alt="move out cleaning"></a>
                </div>
            </div>
        </section>
        
        <div class="wrapper clearfix">
        	<div id="we_offer" style="float:left">
            	<h2><span>Our</span> Services</h2>
                <div id="box">
                	<ul class="list">
                    	<li>Housekeeping, House Cleaning</li>
                        <li>Flats cleaning </li>
                        <li>Floor Cleaning</li>
                        <li>Spring Cleaning </li>
                        <li>Window Cleaning</li>
                        <li>After Construction Cleaning Service</li>
                        <li>Commercial Cleaning</li>
                        <li>Residential Cleaning</li>
                        <li>Office Cleaning</li>
                        <li>Carpet Cleaning</li>
                        <li>Move Out/Move In Cleaning</li>
                        <li>Car Washing</li>
                    </ul>
                </div>
            </div>
            ...
            <div id="welcome">
            	<img src="images/welcome_image.jpg" alt="services"><br>
                <h2>Welcome To <b><span>We</span>Care cleaning service</b></h2>
                <p>We care  cleaning  service is a  group of  experts to provide quality services, We  are  Serving our  Eco-Friendly   Cleaning  Services  and  Quality Maid  Services to our valued  Customers all over Kerala. Our goal is to  consistently  provide the customer  with  100% quality, fast and friendly services.
<br><br>
The  company has  high standard  for  quality  of service, it follow up with customers on a regular basis for feedback of service, aiming to improve the way service customers.</p>
            </div>
        </div>
