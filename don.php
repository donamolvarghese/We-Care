...
$msg=$_POST["msg"];
$rate=$_POST["rate"];
$sql12="INSERT INTO `rat`(`id`,  `rat`, `msg`, `status`) VALUES ('$rid2','$rate','$msg','0')";
...
$sql1="SELECT * FROM `rat`"; //value querried from the table
...
$cnt=$cnt+1;
$rid=$fetch1['id'];
$sql2="SELECT * FROM `registration1` WHERE `id`='$rid'"; //value querried from the table
